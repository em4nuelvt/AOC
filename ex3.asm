...
#DEFINE	BOTAO2	PORTA,1	; Segundo botão - PORTA como entrada
...
#DEFINE	LED	PORTB,0	;PORTA DO LED
			; 0 -> APAGADO
			; 1 -> ACESO
#DEFINE	LED2	PORTB,1	; Segundo LED - PORTB como saída
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
;*                       VETOR DE RESET                            *
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
MAIN
	...
	BTFSC	BOTAO2		; Verifica o estado do segundo botão
	GOTO	BOTAO2_LIB	; Se não pressionado, vai para tratamento do segundo botão liberado
	GOTO	BOTAO2_PRES	; Se pressionado, vai para tratamento do segundo botão pressionado
...
BOTAO2_LIB
	BCF	LED2		; Apaga o LED 2
	GOTO 	MAIN		; Retorna ao loop principal

BOTAO2_PRES
	BSF	LED2		; Acende o LED 2
	GOTO 	MAIN		; Retorna ao loop principal

; A LOGICA DOS DOIS BOTOES ESTÁ DIFERENTE POIS O LED 1 ACENDE QUANDO O BOTAO ESTA SOLTO
; E APAGA QUANDO O BOTAO ESTÁ PRESSIONADO, O LED 2 APAGA QUANDO ESTÁ SOLTO E ACENDE QUADO ESTÁ PRESSIONADO
